...
#ifndef _UAPI_HELIOS_ERRNO_H
#define _UAPI_HELIOS_ERRNO_H 1
...
enum __ERRNO_VALUES {
	...
	EWOULDBLOCK = 41,     /* Operation would block (same as EAGAIN on many systems) */
...
static inline const char* __get_error_string(int errnum)
{
	...
	case EJUKEBOX:		    return "Request initiated, but will not complete before timeout";
