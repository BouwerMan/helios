...
#define KTEST_ASSERT_EQ_GOTO(a, b, label) \
	KTEST_CHECK((a) == (b), #a " == " #b, goto label)
#define KTEST_ASSERT_NE_GOTO(a, b, label) \
	KTEST_CHECK((a) != (b), #a " != " #b, goto label)
#define KTEST_ASSERT_TRUE_GOTO(x, label) KTEST_CHECK((x), #x, goto label)
#define KTEST_ASSERT_FALSE_GOTO(x, label) \
	KTEST_CHECK(!(x), "!(" #x ")", goto label)
